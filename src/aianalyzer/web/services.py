...
def load_profile_payload() -> dict[str, Any]:
    ...
    return {
        ...
        "weekday_hour_matrix": ext.weekday_hour_matrix,
        "peak_cell": {
            "weekday": ext.peak_cell_weekday,
            "hour": ext.peak_cell_hour,
            "count": ext.peak_cell_count,
        },
        "off_peak_session_pct": ext.off_peak_session_pct,
        "model_tier_counts": ext.model_tier_counts,
        "token_economy": {
            "est_input_tokens": ext.est_input_tokens,
            "est_output_tokens": ext.est_output_tokens,
            "est_total_tokens": ext.est_total_tokens,
            "est_cost_usd": ext.est_cost_usd,
            ...
            "actual_total_tokens": ext.actual_total_tokens,
            "actual_input_tokens": ext.actual_input_tokens,
            "actual_output_tokens": ext.actual_output_tokens,
            "actual_cache_read_tokens": ext.actual_cache_read_tokens,
            "actual_cache_write_tokens": ext.actual_cache_write_tokens,
            "actual_reasoning_tokens": ext.actual_reasoning_tokens,
            "actual_cost_usd": ext.actual_cost_usd,
            "total_premium_requests": ext.total_premium_requests,
            "total_nano_aiu": ext.total_nano_aiu,
            "sessions_with_actual_usage": ext.sessions_with_actual_usage,
            "has_billed_data": ext.sessions_with_actual_usage > 0,
        },
        ...
        "personality": compute_personality(
            ...
            longest_streak_days=ext.longest_streak_days,
            top_tools=ext.top_tools,
            total_user_words=ext.total_user_words,
            longest_prompt_words=ext.longest_prompt_words,
            longest_prompt_at=ext.longest_prompt_session_started_at,
            marathon_session_minutes=ext.marathon_session_minutes,
            marathon_session_at=ext.marathon_session_started_at,
            latest_prompt_local_hm=ext.latest_prompt_local_hm,
            latest_prompt_at=ext.latest_prompt_at,
            earliest_prompt_local_hm=ext.earliest_prompt_local_hm,
            earliest_prompt_at=ext.earliest_prompt_at,
            peak_day_count=ext.peak_day_count,
            peak_day_date=ext.peak_day_date,
            weekend_session_pct=ext.weekend_session_pct,
            top_first_words=ext.top_first_words,
            peak_cell_weekday=ext.peak_cell_weekday,
            peak_cell_hour=ext.peak_cell_hour,
            peak_cell_count=ext.peak_cell_count,
            off_peak_session_pct=ext.off_peak_session_pct,
            model_tier_counts=ext.model_tier_counts,
            est_total_tokens=ext.est_total_tokens,
            est_cost_usd=ext.est_cost_usd,
